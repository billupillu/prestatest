...
class TmTopBanner extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Templatemela - TopBannner');
		$this->description = $this->l('Adds a banners for Top banner.');
	}
	...
	public function hookTop()
	{
		...
		return $this->display(__FILE__, 'tmtopbanner.tpl');
	}
	...
	public function getSlides($active = null)
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			SELECT hs.`id_tmtopbanner_slides` as id_slide,
					   hssl.`image`,
					   hss.`position`,
					   hss.`active`,
					   hssl.`title`,
